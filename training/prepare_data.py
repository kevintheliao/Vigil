...
#source label casing is inconsistent
...
#3 annotators; count<2 = tie, dropped
...
#abuse scale {1,0,-1,-2,-3}; mean<0 -> HARASSMENT, mean==1 -> SAFE, else dropped
def load_convabuse(path):
    ...
    for i in annotator_ids:
        ...
        if not cols:
            continue
        #cells sometimes "1, 1" (duplicate submissions); take first value
        parsed = {
